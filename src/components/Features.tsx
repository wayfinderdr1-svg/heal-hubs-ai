  ...
  return <section id="how-it-works" className="py-12 sm:py-16 lg:py-20 bg-cyan-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {features.map((feature, index) => <Card key={index} className="p-4 sm:p-6 bg-card/50 backdrop-blur border-accent/20 hover:shadow-glow transition-all duration-300 overflow-hidden">
